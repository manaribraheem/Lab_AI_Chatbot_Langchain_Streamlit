...
def load_ollama_model():
    ...
    return llm
#I changed the model and embedding model  so the default to samll
...
# create a funtion to load a vector data
...
class chatChain:
    ...
    # stop is  to avoid inventing questions  by itself and hallucination